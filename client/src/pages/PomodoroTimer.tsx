...
const PomodoroTimer: React.FC = () => {
  ...
  const calculateProgress = useCallback(() => {
    const totalSeconds =
      timerMode === "work" ? workDuration * 60 : breakDuration * 60;
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 max-h-[62vh]">
              ...
              {selectedTask ? (
                ...
                <div className="text-center py-2">
                  <div className="bg-gray-100 border-2 border-dashed rounded-xl w-16 h-16 mx-auto mb-4 flex items-center justify-center hover:bg-indigo-700">
                    <button
                      onClick={() => setShowTaskSelector(true)}
